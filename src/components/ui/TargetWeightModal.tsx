...
import { validateTargetWeight } from '@/src/utils/validators';
...
export function TargetWeightModal({
  visible,
  onClose,
  onSave,
  currentWeight,
  ...
  }, [currentWeight, currentDate, visible]);

  const handleSave = () => {
    const validation = validateTargetWeight(weightInput, dateInput);
    if (!validation.valid) {
      Alert.alert('Error', validation.error);
      return;
    }
    onSave(parseFloat(weightInput), dateInput);
    onClose();
  };
